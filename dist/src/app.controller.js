...
let AppController = class AppController {
    root() {
        return {
            message: 'Welcome to the shak_bespoke API 🚀',
            docs: 'docs',
        };
    }
    health() {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'API root info.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'API version info.' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
