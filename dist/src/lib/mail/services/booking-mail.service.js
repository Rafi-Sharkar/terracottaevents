...
let BookingMailService = class BookingMailService {
    ...
    wrapHtml(innerHtml) {
        const logoUrl = this.mailService.getLogoUrl() ||
    ...
    async sendBookingStatusUpdateEmail(to, booking, oldStatus, newStatus) {
        const htmlContent = this.wrapHtml(`
      <h2 style="margin:0 0 16px; text-align:center; font-size:22px; font-weight:700; color:#0A0E27;">
    ...
    async sendPaymentApprovedEmail(to, booking) {
        const htmlContent = this.wrapHtml(`
      <h2 style="margin:0 0 16px; text-align:center; font-size:22px; font-weight:700; color:#0A0E27;">
        Payment Approved!
      </h2>
    ...
    async sendCheckInEmail(to, booking, benefitNames) {
